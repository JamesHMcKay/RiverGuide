...
export const GET_GAUGE_HISTORY_NEW: string = "GET_GAUGE_HISTORY_NEW";
export const CLEAR_GAUGE_HISTORY_NEW: string = "CLEAR_GAUGE_HISTORY_NEW";
...
export const GENERATE_FILTERED_LIST_APPEND: string =
