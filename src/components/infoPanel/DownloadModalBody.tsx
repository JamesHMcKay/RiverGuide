...
class DownloadModalBody extends Component<
  IDownloadModalBodyProps,
  IDownloadModalBodyState
> {
  ...
  public render(): JSX.Element {
    const data: Array<Partial<IObsValue>> = [];
    return (
      <div>
...
export default connect(mapStateToProps, {})(DownloadModalBody);
